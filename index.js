...
createServer(async (req, res) => {
  ...
  console.log(`PATCH ${URI_PREFIX}/{id} - alterar uma tarefa por ID, você precisa passar um objeto no corpo da solicitação { name?: string, owner?: string, done?: boolean }`);
  console.log(`DELETE ${URI_PREFIX}/{id} - excluir uma tarefa por ID`);
  console.log(`PATCH ${URI_PREFIX}/mark-all-done - marcar todas as tarefas como concluídas`);
  console.log(`GET ${URI_PREFIX}/incomplete - obter todas as tarefas incompletas`);
});
